...
export function EmbeddingSpace({
  ...
  return (
    <div className="retro-panel w-full h-full flex flex-col overflow-hidden">
      <div className="retro-label z-10 w-full shrink-0 flex justify-between items-center gap-2">
